...
class ExerciseRunner:
    ...
    def run_exercise(self):
        ...
        plt.figure(1)
        plt.plot(range(0, 150, 10), flow_out_list, '-o', c='red', alpha=0.5, label='Count_packets_out register values')
        ...
        plt.show()
        plt.figure(2)
        plt.plot(range(0, 150, 10), flow_in_list, '-o', c='blue', alpha=0.5, label='Count_packets_in register values')
